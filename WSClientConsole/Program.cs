...
namespace WSClientConsole
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //                catch (Exception e)
            //                {
            //                    Console.WriteLine("GET ALL ERROR!!" + e.Message);
            //                    Console.ReadLine();
            //                }
            //            }
            ...
            //                {
            //                    Console.WriteLine("GET 1 ERROR!!" + e.Message);
            //                }
            //            }
            ...
            //                catch (Exception e)
            //                {
            //                    Console.WriteLine("It's fucked: " + e.Message);
            //                }
            //            }
            ...
            //                catch (Exception e)
            //                {
            //                    Console.WriteLine("Fuck up" + e.Message);
            //                }
            //            }
                    ...
                    if (getHotelResponse.IsSuccessStatusCode)
                    {
                        ...
                        if (getRoomResponse.IsSuccessStatusCode)
                        {
                            ...
                            foreach (var hr in roomQuery)
                            {
                                try
                                {
                                    Console.WriteLine("Room price before: "+ hr.Price);

                                    hr.Price *= 1.2;
                                    string putRoom = "api/rooms/" + hr.Room_No;

                                    var roomResponse = client.PutAsJsonAsync(putRoom, hr).Result;
                                    if (roomResponse.IsSuccessStatusCode)
                                    {
                                        Console.WriteLine("Status Code: " + roomResponse.IsSuccessStatusCode);
                                        Console.WriteLine("Room price after: " + hr.Price);
                                    }
                                }
                                catch (Exception e)
                                {
